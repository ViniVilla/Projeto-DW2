...
insert into ordem_servico(id, usuario_id, endereco_id, instalador_id, plano, data_criacao, data_atribuicao) values (1, 1, 1, 1, 'MONO', '2019-11-10', '2019-11-15');

insert into endereco(id, cidade, bairro, rua) values (2, 'cidade', 'bairro', 'rua');
insert into ordem_servico(id, usuario_id, endereco_id, instalador_id, plano, data_criacao, data_atribuicao) values (2, 1, 2, 1, 'MONO', '2019-11-10', '2019-11-15');

insert into endereco(id, cidade, bairro, rua) values (3, 'cidade', 'bairro', 'rua');
insert into ordem_servico(id, usuario_id, endereco_id, instalador_id, plano, data_criacao, data_atribuicao) values (3, 1, 3, 1, 'MONO', '2019-11-10', '2019-11-15');

insert into endereco(id, cidade, bairro, rua) values (4, 'cidade', 'bairro', 'rua');
insert into ordem_servico(id, usuario_id, endereco_id, instalador_id, plano, data_criacao, data_atribuicao) values (4, 1, 4, 1, 'MONO', '2019-11-10', '2019-11-15');
